...
// Token is a free data retrieval call binding the contract method 0xfde8e727.
//
// Solidity: function token(address u, uint256 m, uint256 p) view returns(address)
func (_MarketPlace *MarketPlaceCaller) Token(opts *bind.CallOpts, u common.Address, m *big.Int, p *big.Int) (common.Address, error) {
	var out []interface{}
	err := _MarketPlace.contract.Call(opts, &out, "token", u, m, p)
...
//
// Solidity: function token(address u, uint256 m, uint256 p) view returns(address)
func (_MarketPlace *MarketPlaceSession) Token(u common.Address, m *big.Int, p *big.Int) (common.Address, error) {
	return _MarketPlace.Contract.Token(&_MarketPlace.CallOpts, u, m, p)
}

// Token is a free data retrieval call binding the contract method 0xfde8e727.
//
// Solidity: function token(address u, uint256 m, uint256 p) view returns(address)
func (_MarketPlace *MarketPlaceCallerSession) Token(u common.Address, m *big.Int, p *big.Int) (common.Address, error) {
	return _MarketPlace.Contract.Token(&_MarketPlace.CallOpts, u, m, p)
}
...
// CreateMarket is a paid mutator transaction binding the contract method 0xfce8bfce.
//
// Solidity: function createMarket(address u, uint256 m, address[8] t, string n, string s, address e, address a) returns(bool)
func (_MarketPlace *MarketPlaceTransactor) CreateMarket(opts *bind.TransactOpts, u common.Address, m *big.Int, t [8]common.Address, n string, s string, e common.Address, a common.Address) (*types.Transaction, error) {
	return _MarketPlace.contract.Transact(opts, "createMarket", u, m, t, n, s, e, a)
}

// CreateMarket is a paid mutator transaction binding the contract method 0xfce8bfce.
//
// Solidity: function createMarket(address u, uint256 m, address[8] t, string n, string s, address e, address a) returns(bool)
func (_MarketPlace *MarketPlaceSession) CreateMarket(u common.Address, m *big.Int, t [8]common.Address, n string, s string, e common.Address, a common.Address) (*types.Transaction, error) {
	return _MarketPlace.Contract.CreateMarket(&_MarketPlace.TransactOpts, u, m, t, n, s, e, a)
}

// CreateMarket is a paid mutator transaction binding the contract method 0xfce8bfce.
//
// Solidity: function createMarket(address u, uint256 m, address[8] t, string n, string s, address e, address a) returns(bool)
func (_MarketPlace *MarketPlaceTransactorSession) CreateMarket(u common.Address, m *big.Int, t [8]common.Address, n string, s string, e common.Address, a common.Address) (*types.Transaction, error) {
	return _MarketPlace.Contract.CreateMarket(&_MarketPlace.TransactOpts, u, m, t, n, s, e, a)
}
