...
// Redeem0 is a paid mutator transaction binding the contract method 0x80b72958.
//
// Solidity: function redeem(uint8 p, address u, uint256 m, uint256 s, address a) returns(bool)
func (_Redeemer *RedeemerTransactor) Redeem0(opts *bind.TransactOpts, p uint8, u common.Address, m *big.Int, s *big.Int, a common.Address) (*types.Transaction, error) {
	return _Redeemer.contract.Transact(opts, "redeem0", p, u, m, s, a)
}

// Redeem0 is a paid mutator transaction binding the contract method 0x80b72958.
//
// Solidity: function redeem(uint8 p, address u, uint256 m, uint256 s, address a) returns(bool)
func (_Redeemer *RedeemerSession) Redeem0(p uint8, u common.Address, m *big.Int, s *big.Int, a common.Address) (*types.Transaction, error) {
	return _Redeemer.Contract.Redeem0(&_Redeemer.TransactOpts, p, u, m, s, a)
}

// Redeem0 is a paid mutator transaction binding the contract method 0x80b72958.
//
// Solidity: function redeem(uint8 p, address u, uint256 m, uint256 s, address a) returns(bool)
func (_Redeemer *RedeemerTransactorSession) Redeem0(p uint8, u common.Address, m *big.Int, s *big.Int, a common.Address) (*types.Transaction, error) {
	return _Redeemer.Contract.Redeem0(&_Redeemer.TransactOpts, p, u, m, s, a)
}

// Redeem1 is a paid mutator transaction binding the contract method 0xa1b1138c.
//
// Solidity: function redeem(uint8 p, address u, uint256 m) returns(bool)
func (_Redeemer *RedeemerTransactor) Redeem1(opts *bind.TransactOpts, p uint8, u common.Address, m *big.Int) (*types.Transaction, error) {
	return _Redeemer.contract.Transact(opts, "redeem1", p, u, m)
}

// Redeem1 is a paid mutator transaction binding the contract method 0xa1b1138c.
//
// Solidity: function redeem(uint8 p, address u, uint256 m) returns(bool)
func (_Redeemer *RedeemerSession) Redeem1(p uint8, u common.Address, m *big.Int) (*types.Transaction, error) {
	return _Redeemer.Contract.Redeem1(&_Redeemer.TransactOpts, p, u, m)
}

// Redeem1 is a paid mutator transaction binding the contract method 0xa1b1138c.
//
// Solidity: function redeem(uint8 p, address u, uint256 m) returns(bool)
func (_Redeemer *RedeemerTransactorSession) Redeem1(p uint8, u common.Address, m *big.Int) (*types.Transaction, error) {
	return _Redeemer.Contract.Redeem1(&_Redeemer.TransactOpts, p, u, m)
}
...
//
// Solidity: function setConverter(address c) returns(bool)
func (_Redeemer *RedeemerTransactor) SetConverter(opts *bind.TransactOpts, c common.Address) (*types.Transaction, error) {
	return _Redeemer.contract.Transact(opts, "setConverter", c)
}

// SetConverter is a paid mutator transaction binding the contract method 0xb19337a4.
//
// Solidity: function setConverter(address c) returns(bool)
func (_Redeemer *RedeemerSession) SetConverter(c common.Address) (*types.Transaction, error) {
	return _Redeemer.Contract.SetConverter(&_Redeemer.TransactOpts, c)
}

// SetConverter is a paid mutator transaction binding the contract method 0xb19337a4.
//
// Solidity: function setConverter(address c) returns(bool)
func (_Redeemer *RedeemerTransactorSession) SetConverter(c common.Address) (*types.Transaction, error) {
	return _Redeemer.Contract.SetConverter(&_Redeemer.TransactOpts, c)
}
...
// FilterRedeem is a free log retrieval operation binding the contract event 0x81ffec6ddb31111dfec90cc68941cdb9bfb0d4cf2c629b3ee7f18422accbf44d.
//
// Solidity: event Redeem(uint8 principal, address indexed underlying, uint256 indexed maturity, uint256 amount, address sender)
...
// WatchRedeem is a free log subscription operation binding the contract event 0x81ffec6ddb31111dfec90cc68941cdb9bfb0d4cf2c629b3ee7f18422accbf44d.
//
// Solidity: event Redeem(uint8 principal, address indexed underlying, uint256 indexed maturity, uint256 amount, address sender)
...
// ParseRedeem is a log parse operation binding the contract event 0x81ffec6ddb31111dfec90cc68941cdb9bfb0d4cf2c629b3ee7f18422accbf44d.
//
// Solidity: event Redeem(uint8 principal, address indexed underlying, uint256 indexed maturity, uint256 amount, address sender)
