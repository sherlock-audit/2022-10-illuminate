...
// Paused is a free data retrieval call binding the contract method 0xe25980c5.
//
// Solidity: function paused(address , uint256 , uint256 ) view returns(bool)
func (_Lender *LenderCaller) Paused(opts *bind.CallOpts, arg0 common.Address, arg1 *big.Int, arg2 *big.Int) (bool, error) {
	var out []interface{}
	err := _Lender.contract.Call(opts, &out, "paused", arg0, arg1, arg2)
...
//
// Solidity: function paused(address , uint256 , uint256 ) view returns(bool)
func (_Lender *LenderSession) Paused(arg0 common.Address, arg1 *big.Int, arg2 *big.Int) (bool, error) {
	return _Lender.Contract.Paused(&_Lender.CallOpts, arg0, arg1, arg2)
}

// Paused is a free data retrieval call binding the contract method 0xe25980c5.
//
// Solidity: function paused(address , uint256 , uint256 ) view returns(bool)
func (_Lender *LenderCallerSession) Paused(arg0 common.Address, arg1 *big.Int, arg2 *big.Int) (bool, error) {
	return _Lender.Contract.Paused(&_Lender.CallOpts, arg0, arg1, arg2)
}
...
// Approve1 is a paid mutator transaction binding the contract method 0x962cb793.
//
// Solidity: function approve(address u, address a, address e, address n) returns()
func (_Lender *LenderTransactor) Approve1(opts *bind.TransactOpts, u common.Address, a common.Address, e common.Address, n common.Address) (*types.Transaction, error) {
	return _Lender.contract.Transact(opts, "approve1", u, a, e, n)
}

// Approve1 is a paid mutator transaction binding the contract method 0x962cb793.
//
// Solidity: function approve(address u, address a, address e, address n) returns()
func (_Lender *LenderSession) Approve1(u common.Address, a common.Address, e common.Address, n common.Address) (*types.Transaction, error) {
	return _Lender.Contract.Approve1(&_Lender.TransactOpts, u, a, e, n)
}

// Approve1 is a paid mutator transaction binding the contract method 0x962cb793.
//
// Solidity: function approve(address u, address a, address e, address n) returns()
func (_Lender *LenderTransactorSession) Approve1(u common.Address, a common.Address, e common.Address, n common.Address) (*types.Transaction, error) {
	return _Lender.Contract.Approve1(&_Lender.TransactOpts, u, a, e, n)
}
...
// Lend5 is a paid mutator transaction binding the contract method 0xe448b458.
//
// Solidity: function lend(uint8 p, address u, uint256 m, uint256 a, uint256 r, uint256 d, address x, address pool) returns(uint256)
func (_Lender *LenderTransactor) Lend5(opts *bind.TransactOpts, p uint8, u common.Address, m *big.Int, a *big.Int, r *big.Int, d *big.Int, x common.Address, pool common.Address) (*types.Transaction, error) {
	return _Lender.contract.Transact(opts, "lend5", p, u, m, a, r, d, x, pool)
}

// Lend5 is a paid mutator transaction binding the contract method 0xe448b458.
//
// Solidity: function lend(uint8 p, address u, uint256 m, uint256 a, uint256 r, uint256 d, address x, address pool) returns(uint256)
func (_Lender *LenderSession) Lend5(p uint8, u common.Address, m *big.Int, a *big.Int, r *big.Int, d *big.Int, x common.Address, pool common.Address) (*types.Transaction, error) {
	return _Lender.Contract.Lend5(&_Lender.TransactOpts, p, u, m, a, r, d, x, pool)
}

// Lend5 is a paid mutator transaction binding the contract method 0xe448b458.
//
// Solidity: function lend(uint8 p, address u, uint256 m, uint256 a, uint256 r, uint256 d, address x, address pool) returns(uint256)
func (_Lender *LenderTransactorSession) Lend5(p uint8, u common.Address, m *big.Int, a *big.Int, r *big.Int, d *big.Int, x common.Address, pool common.Address) (*types.Transaction, error) {
	return _Lender.Contract.Lend5(&_Lender.TransactOpts, p, u, m, a, r, d, x, pool)
}

// Lend6 is a paid mutator transaction binding the contract method 0xeda8ff6b.
//
// Solidity: function lend(uint8 p, address u, uint256 m, uint256 a, uint256 r, uint256 d, address x) returns(uint256)
func (_Lender *LenderTransactor) Lend6(opts *bind.TransactOpts, p uint8, u common.Address, m *big.Int, a *big.Int, r *big.Int, d *big.Int, x common.Address) (*types.Transaction, error) {
	return _Lender.contract.Transact(opts, "lend6", p, u, m, a, r, d, x)
}

// Lend6 is a paid mutator transaction binding the contract method 0xeda8ff6b.
//
// Solidity: function lend(uint8 p, address u, uint256 m, uint256 a, uint256 r, uint256 d, address x) returns(uint256)
func (_Lender *LenderSession) Lend6(p uint8, u common.Address, m *big.Int, a *big.Int, r *big.Int, d *big.Int, x common.Address) (*types.Transaction, error) {
	return _Lender.Contract.Lend6(&_Lender.TransactOpts, p, u, m, a, r, d, x)
}

// Lend6 is a paid mutator transaction binding the contract method 0xeda8ff6b.
//
// Solidity: function lend(uint8 p, address u, uint256 m, uint256 a, uint256 r, uint256 d, address x) returns(uint256)
func (_Lender *LenderTransactorSession) Lend6(p uint8, u common.Address, m *big.Int, a *big.Int, r *big.Int, d *big.Int, x common.Address) (*types.Transaction, error) {
	return _Lender.Contract.Lend6(&_Lender.TransactOpts, p, u, m, a, r, d, x)
}
...
// Pause is a paid mutator transaction binding the contract method 0x735d4275.
//
// Solidity: function pause(address u, uint256 m, uint8 p, bool b) returns(bool)
func (_Lender *LenderTransactor) Pause(opts *bind.TransactOpts, u common.Address, m *big.Int, p uint8, b bool) (*types.Transaction, error) {
	return _Lender.contract.Transact(opts, "pause", u, m, p, b)
}

// Pause is a paid mutator transaction binding the contract method 0x735d4275.
//
// Solidity: function pause(address u, uint256 m, uint8 p, bool b) returns(bool)
func (_Lender *LenderSession) Pause(u common.Address, m *big.Int, p uint8, b bool) (*types.Transaction, error) {
	return _Lender.Contract.Pause(&_Lender.TransactOpts, u, m, p, b)
}

// Pause is a paid mutator transaction binding the contract method 0x735d4275.
//
// Solidity: function pause(address u, uint256 m, uint8 p, bool b) returns(bool)
func (_Lender *LenderTransactorSession) Pause(u common.Address, m *big.Int, p uint8, b bool) (*types.Transaction, error) {
	return _Lender.Contract.Pause(&_Lender.TransactOpts, u, m, p, b)
}
...
// LenderPauseMarketIterator is returned from FilterPauseMarket and is used to iterate over the raw logs and unpacked data for PauseMarket events raised by the Lender contract.
type LenderPauseMarketIterator struct {
	Event *LenderPauseMarket // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *LenderPauseMarketIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(LenderPauseMarket)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *LenderPauseMarketIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *LenderPauseMarketIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// LenderPauseMarket represents a PauseMarket event raised by the Lender contract.
type LenderPauseMarket struct {
	Principal  uint8
	Underlying common.Address
	Maturity   *big.Int
	Token      common.Address
...
// FilterPauseMarket is a free log retrieval operation binding the contract event 0x6dcb329df14c12c3c254e8dc60b73c30690a5ab362e2918f914f0582daa5340e.
//
// Solidity: event PauseMarket(uint8 principal, address indexed underlying, uint256 indexed maturity, address token, bool indexed state)
func (_Lender *LenderFilterer) FilterPauseMarket(opts *bind.FilterOpts, underlying []common.Address, maturity []*big.Int, state []bool) (*LenderPauseMarketIterator, error) {
	...
	logs, sub, err := _Lender.contract.FilterLogs(opts, "PauseMarket", underlyingRule, maturityRule, stateRule)
	if err != nil {
		return nil, err
	}
	return &LenderPauseMarketIterator{contract: _Lender.contract, event: "PauseMarket", logs: logs, sub: sub}, nil
}

// WatchPauseMarket is a free log subscription operation binding the contract event 0x6dcb329df14c12c3c254e8dc60b73c30690a5ab362e2918f914f0582daa5340e.
//
// Solidity: event PauseMarket(uint8 principal, address indexed underlying, uint256 indexed maturity, address token, bool indexed state)
func (_Lender *LenderFilterer) WatchPauseMarket(opts *bind.WatchOpts, sink chan<- *LenderPauseMarket, underlying []common.Address, maturity []*big.Int, state []bool) (event.Subscription, error) {
	...
	logs, sub, err := _Lender.contract.WatchLogs(opts, "PauseMarket", underlyingRule, maturityRule, stateRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(LenderPauseMarket)
				if err := _Lender.contract.UnpackLog(event, "PauseMarket", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParsePauseMarket is a log parse operation binding the contract event 0x6dcb329df14c12c3c254e8dc60b73c30690a5ab362e2918f914f0582daa5340e.
//
// Solidity: event PauseMarket(uint8 principal, address indexed underlying, uint256 indexed maturity, address token, bool indexed state)
func (_Lender *LenderFilterer) ParsePauseMarket(log types.Log) (*LenderPauseMarket, error) {
	event := new(LenderPauseMarket)
	if err := _Lender.contract.UnpackLog(event, "PauseMarket", log); err != nil {
		return nil, err
	}
