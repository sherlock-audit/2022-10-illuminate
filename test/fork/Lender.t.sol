...
contract LenderTest is Test {
    ...
    function testSwivelLendSkip() public {
        ...
        deal(Contracts.DAI, user1_pk, startingBalance / 4, true);
        deal(Contracts.DAI, msg.sender, startingBalance / 4, true);
        IERC20(Contracts.DAI).approve(address(l), startingBalance);
    ...
    function testAPWineLend() public {
        ...
        deal(Contracts.USDT, msg.sender, startingBalance);
